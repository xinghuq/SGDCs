...
partcorcomDis_Fst_geodis=function(comm,g,geo,ncode, method,permutations){
  ...
  partcorgeo=mantel.partial(PFst, Comdist, geo, permutations, method = "pearson")
  return(corDis_Fst_geo=partcorgeo)
}
