############## This function calculate beta SGDCs, which correlates community species differentiation and genetic differentiation measured by Delta D#######


betaSGDC=function(comm,g,ncode,nrepet){
    ...
    betaSGDC=mantel.randtest(Dcom, DeltaDp,nrepet)
    
    return(list(PairwiseDpop = DeltaDp, pairwiseDcom = Dcom, betaSGDC = betaSGDC))
  }
